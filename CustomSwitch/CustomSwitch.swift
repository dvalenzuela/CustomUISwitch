...
final class CustomSwitch: UIControl {
    ...
    @IBInspectable public var borderColor: UIColor = UIColor.clear {
        didSet {
            self.thumbView.borderColor = self.borderColor
            self.layoutSubviews()
        }
    }
    ...
    @IBInspectable public var borderWidth: CGFloat = 0.0 {
        didSet {
            self.thumbView.borderWidth = borderWidth
            self.layoutSubviews()
        }
    }
    ...
    @IBInspectable public var thumbOnImage:UIImage? = nil {
        didSet {
            self.thumbView.thumbImageView.image = self.isOn ? self.thumbOnImage : self.thumbOffImage
        }
    }
